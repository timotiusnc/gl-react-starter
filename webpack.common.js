...
module.exports = {
  ...
  optimization: {
    // Without `runtimeChunk`, the hash will be different even though there's no update
    ...
    splitChunks: {
      ...
      // Minimum size, in bytes, for a chunk to be generated. If a vendor file is N KB and minSize is M (M < N), it will get merged with other
      // maxInitialRequests and minSize together will make all our vendor files outputted as is
      minSize: 0,
